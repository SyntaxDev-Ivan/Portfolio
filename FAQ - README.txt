Wie öffne ich ein Projekt, nachdem ich es geclonet habe (git clone url)?
  ----------------------------------
  im Frontend
    -no-frameworks öffnest du wie folgt:
      ...
      (meistens index.html) rechtsklick und "mit Liveserver öffnen | Open with Liveserver"
      ---
  ...
  ------------------------------------
    -Angular
      ...
      in deiner Eingabeaufforderung in das Verzeichnis, welches du öffnen willst und rufst den Command:
      "npm i", damit alle Packete, die erfordelich sind, installiert werden.
      Ist die Installation fertig gib in die "Commandzeile" folgendes: "ng serve", nun wird dir der Port
